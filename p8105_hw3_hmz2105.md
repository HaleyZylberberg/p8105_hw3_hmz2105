...
excellent_brfss_smart2010_df =
  ...
  group_by(year, state) |>
  summarize (score = mean(data_value)) |>
...
![](p8105_hw3_hmz2105_files/figure-gfm/excellent%20observations%20dataset-1.png)<!-- -->

``` r
brfss_smart2010_df|>
  filter(state == "NY", year == "2006" | year == "2010") |>
  ggplot(aes(x = county, y=data_value, fill = overall_health)) +
  geom_bar(stat="identity") +
  facet_grid(~year)
```

![](p8105_hw3_hmz2105_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->
