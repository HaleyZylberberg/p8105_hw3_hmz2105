...
This plot shows that from years 2002 through 2010 (which is the duration of the data) the mean proportion of participants who responded "excellent" to the question " How is your overall health" was less than 30 for every state. It seems that most states have an "excellent" response of about 0.22%. Overall there appears to be a decreasing trend for the "excellent" response over time.  
